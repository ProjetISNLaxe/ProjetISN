...
class perso1(perso):
    def __init__(self):
        perso.__init__(self, "imagebonhomme\\joueur\\combivaisseau\\Perso1nship0.png", "imagebonhomme\\joueur\\combivaisseau\\Perso1nship1.png")
        self.vie=150
        self.mana=100
        self.fleche=0
        self.armure=0
...
class perso3(perso):
    def __init__(self):
        perso.__init__(self, "imagebonhomme\\perso3\\perso3armurebase.png", "imagebonhomme\\perso3\\perso3armurebase2.png")
        self.vie=100
        self.active=False
        self.poison=False
