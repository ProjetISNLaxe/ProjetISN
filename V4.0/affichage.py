...
def affichage(action,tour,choix):
    ...
    fond=pygame.image.load("fon.png")
    bandeaubleue = pygame.image.load("Fightblue.png").convert_alpha()
    bandeaurouge = pygame.image.load("Fightred.png").convert_alpha()
...
def affichageanim(d,tour,variableanim):
    ...
    bandeaubleue = pygame.image.load("Fightblue.png").convert_alpha()
    bandeaurouge = pygame.image.load("Fightred.png").convert_alpha()
    fouldebeu = pygame.image.load("fireball.png").convert_alpha()
    fouldebeunul = pygame.image.load("fireballkitomb.png").convert_alpha()
